    ...
    <Box component="main" sx={{ pb: 4 }}>
      <Grid container spacing={4}>
        <Grid item xs={12} md={4}>
          <Paper elevation={3} sx={{ p: 3, borderRadius: 4, position: { md: 'sticky' }, top: 32 }}>
            <Stack spacing={3}>
              <Box>
              ...
              <Paper variant="outlined" sx={{ p: 3, borderRadius: 4, bgcolor: 'background.paper' }}>
                <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 1 }}>{user.full_name}</Typography>
